...
export default function Profile() {
  ...
  return (
    <>
      <div className="Full Flex Column" style={{ padding: '3rem 3rem 0', alignItems: 'flex-start', gap: '1rem' }}>
        <div className="Full Flex Center" style={{ justifyContent: 'space-between', marginBottom: '0.6rem' }}>
          <img
            src="/Amanda.jpg"
            style={{ height: '6.5rem', borderRadius: '50%', border: '0.1rem solid var(--orange)' }}></img>
        ...
        <div className="Full Flex" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
          <TransitionElement>
            <div className="Flex Column" style={{ alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <p className="Thin Mid">
                {' '}
                Actress & model. <br></br> Certified personal trainer.{' '}
              </p>
            </div>
          </TransitionElement>
        ...
        <div className="Full Flex" style={{ alignItems: 'center', gap: '0.4rem' }}>
          ...
          <p className="Thin Mid">
            {' '}
            Incentive saved you: <span className="Bold"> $20 </span>
          </p>
        </div>
      </div>
          ...
          <ul className="Full Flex Small">
            {tabs.map(item => (
              <li
                ...
                {item}
                {item == selectedTab ? <motion.div className="tabUnderline" layoutId="tabUnderline" /> : null}
              </li>
            ))}
          </ul>
        </nav>
            ...
            <motion.div
              ...
              {selectedTab == tabs[0] ? (
                <div className="Full Flex Column" style={{ gap: '1rem' }}>
                  <div
                    className="Full Flex Inc IncNow"
                    style={{ padding: '1rem', alignItems: 'center', justifyContent: 'flex-start', gap: '1rem' }}>
