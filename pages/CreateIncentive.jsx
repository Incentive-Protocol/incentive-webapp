...
export default function CreateIncentive() {
    ...
    const NFT_STORAGE_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDcyOTU1MzQ4MTQ4YjVCMTgyQzUwN0E1N0FjNjFFY2ZjYTRjYUVFYjMiLCJpc3MiOiJuZnQtc3RvcmFnZSIsImlhdCI6MTY2MzM0NDE1Mjg1OCwibmFtZSI6IkNMRVNTSU8ifQ.W_PlVWKNvyGsKCvASjnJJeQ9bzVOnQaAM31MJdVYPME'
    ...
    const createIncentive = async (cidMetadata) => {
        ...
        try {
            const tx = await incentiveContract.createIncentive(
                cidMetadata,
                parsedPrice._hex,
                address
            )
                ...
                <div className="Full Flex Center Column" style={{ gap: "3rem" }}>
                    ...
                    <div className="Flex" style={{ width: "100%", justifyContent: "space-between", alignItems: "flex-end" }}>
                        ...
                        <div className="Flex Column Small" style={{ width: "70%", alignItems: "flex-start" }}>
                            ...
                            <div className="Flex InputWithLabel">
                                <input className="IncentiveInput" placeholder="Name incentive"
                                    onChange={e => {
                        ...
                        <div className="Flex Center" style={{ width: "4rem", height: "4rem", background: "var(--orange)", borderRadius: "50%", marginBottom: "0.25rem" }}>
                    ...
                    <div className="Flex" style={{ justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <div className="Flex Column Small" style={{ width: "40%", alignItems: "flex-start" }}>
                            ...
                            <div className="Flex InputWithLabel">
                                <input className="IncentiveInput" placeholder="0.00"
                                    onChange={e => {
                    ...
                    <div className="Flex Column Small" style={{ width: "100%", alignItems: "flex-start" }}>
                        ...
                        <div className="Flex Center InputWithLabel" style={{ width: "100%", height: "10rem" }}>
                            <textarea className="IncentiveInput" style={{ width: "100%", height: "8rem", resize: "none" }} placeholder=""
                                onChange={e => {
...
CreateIncentive.getLayout = function getLayout(page) {
    return (
        <LayoutBusiness>{page}</LayoutBusiness>
    )
}